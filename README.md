...
- Kommunenummer/fylkesnummer: programmet laster per nå inn en Excel-fil "kommune_fylke_kartverket.xlsx"  med kommune- og fylkesnumre kopiert inn i Excel fra https://www.kartverket.no/til-lands/fakta-om-norge/norske-fylke-og-kommunar.
  ...
  Det er uklart om Excel-filen er god, og det vil være bedre å bytte til f.eks. SSBs KLASS-API, men funksjonaliteten illustreres helt fint.
  Det er mulig å droppe kommunenummersjekk og fylkesnummerberikning ved å ikke inkludere "kommune_fylke_kartverket.xlsx", uten at det medfører andre problemer enn at fylkesnummer ikke legges til.
- Inntektsnivå beregnes basert på tre kvantiler, slik at fordelingen alltid gir tre grupper uavhengig av faktisk inntektsfordeling i datasett. Tar ikke høyde for ekstremverdier utover å fjerne rader med inntekt 0 eller mindre i valideringsfasen. Fordelingen kan være misvisende, men er tatt med hensyn på tiltentk uvitenhet om mulige verdier i et stort datasett. Spesielle tilfeller som at alle i datasettet har samme inntekt medfører at inntektsnivå ikke genereres.
